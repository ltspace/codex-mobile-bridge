...
$QueuedMessages = if ($Health -and $Health.PSObject.Properties['drafts'] -and $Health.drafts.PSObject.Properties['queuedMessages']) { $Health.drafts.queuedMessages } else { 0 }
