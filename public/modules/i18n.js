...
const messages = {
  en: {
    ...
    "connection.degraded": "Codex recovering",
    ...
    "actions.archive": "Archive conversation",
    "actions.retry": "Retry",
    "actions.close": "Close",
    "actions.cancel": "Cancel",
    "actions.cancelQueued": "Cancel queued message",
    ...
    "threads.filter": "Conversation source",
    ...
    "threads.noneOpenClaw": "No OpenClaw conversations found",
    ...
    "threads.selectOpenClaw": "Select an OpenClaw conversation",
    "threads.selectHelp": "Open one from the list or create a new one",
    "threads.selectHelpOpenClaw": "Open one from the list",
    ...
    "turn.waitingOtherClient": "Waiting for other client",
    "turn.failed": "Failed",
    ...
    "composer.recovering": "Codex is clearing a slow request queue; your draft is preserved",
    "composer.otherClient": "This conversation is running in another client",
    "composer.otherClientQueue": "The other client keeps running; your message will wait and send automatically",
    "composer.steerHint": "Your message will be added to the active task",
    "composer.queueHint": "The current task keeps running; your message will run next",
    "composer.keyboardHint": "Enter to send · Shift + Enter for a new line",
    "model.settings": "Model settings",
    "model.label": "Model",
    "model.effort": "Reasoning level",
    "model.appliesNext": "Applies to the next turn",
    "model.loading": "Loading models…",
    "model.unavailable": "Models unavailable",
    "model.saved": "Model settings updated",
    "effort.low": "Low",
    ...
    "toast.queued": "Queued at position {position}",
    "toast.queueCancelled": "Queued message cancelled",
    "toast.stopSent": "Stop request sent",
    "toast.submitted": "Submitted",
    "toast.refreshed": "Refreshed",
    "toast.archived": "Conversation archived",
    "toast.takeoverComplete": "Desktop writer released; sending the queued message",
    "archive.confirm": "Archive \u201c{title}\u201d? You can restore it from another Codex client.",
    "takeover.title": "Conversation held on desktop",
    "takeover.description": "A queued message is waiting for the desktop Codex writer.",
    "takeover.confirm": "Take over “{title}”?\n\nThe desktop task is idle and this verified VS Code Codex App Server owns only this conversation. PID {pid} will be stopped; VS Code, OpenClaw, and the mobile Bridge will keep running.",
    "takeover.owner_missing": "The desktop writer has already exited. Retrying the queued message.",
    "takeover.protected_owner": "The writer belongs to the mobile Bridge and cannot be stopped.",
    "takeover.unsupported_owner": "The writer is not a verified VS Code Codex process, so takeover was refused.",
    "takeover.multiple_owners": "More than one writer was reported, so takeover was refused.",
    "takeover.shared_owner": "This desktop Codex process owns {count} conversations. Takeover was refused to protect their history.",
    "takeover.active_remote_turn": "The desktop task is still running. Stop it on the desktop first; forced takeover was refused to protect the conversation history.",
    "takeover.thread_state_unknown": "The desktop task could not be confirmed idle, so takeover was refused.",
    "takeover.unsupported_platform": "Safe process takeover is only available on Windows.",
    ...
    "status.recovering": "recovering request queue",
    ...
    "errors.invalid_send_mode": "This message mode is not supported",
    "errors.invalid_model_settings": "Choose a valid model and reasoning level",
    "errors.thread_has_queued_messages": "This conversation still has queued messages; archive it after they are sent",
    ...
    "errors.queue_dispatching": "This message is being sent; wait a moment and try cancelling again",
    "errors.queued_message_not_found": "This queued message was already sent or cancelled",
    ...
    "errors.codex_recovering": "Codex is recovering its request queue; try again in {seconds} seconds",
    "errors.archive_busy": "Another conversation is being archived; try again when it finishes",
    "errors.archive_timeout": "Archive was not confirmed in time; the main connection is still available. Refresh to check the result",
    "errors.archive_unavailable": "The isolated archive service could not start; try again shortly",
    ...
    "errors.invalid_thread_client": "The conversation source is invalid",
    "errors.takeover_not_needed": "This conversation is no longer blocked by another client",
    "errors.takeover_busy": "Conversation takeover is already in progress",
    "errors.takeover_protected_owner": "The writer belongs to the mobile Bridge and cannot be stopped",
    "errors.takeover_unsupported_owner": "The writer is not a verified VS Code Codex process",
    "errors.takeover_multiple_owners": "More than one writer was reported; takeover was refused",
    "errors.takeover_shared_owner": "The desktop Codex process owns other conversations and cannot be stopped safely",
    "errors.takeover_active_remote_turn": "The desktop task is still running; forced takeover was refused to protect its history",
    "errors.takeover_thread_state_unknown": "The desktop task state could not be confirmed; takeover was refused",
    "errors.takeover_unsupported_platform": "Safe process takeover is only available on Windows",
    "errors.takeover_owner_changed": "The desktop writer changed; inspect and confirm again",
    "errors.takeover_failed": "The desktop writer could not be released safely",
  ...
  "zh-CN": {
    ...
    "actions.takeover": "接管会话",
    "actions.inspecting": "检测中…",
    "menu.open": "打开会话列表",
    "menu.close": "关闭会话列表",
    "menu.actions": "更多操作",
    ...
    "turn.waitingOtherClient": "等待其他客户端释放",
    "turn.failed": "失败",
    "turn.stopped": "已停止",
    "turn.completed": "完成",
    ...
    "composer.recovering": "Codex 正在清理慢请求队列；草稿已保留",
    "composer.otherClient": "此会话正在其他客户端运行",
    "composer.otherClientQueue": "另一端继续执行；这条消息会等待并自动发送",
    "composer.steerHint": "当前输入将追加到正在执行的任务",
    "composer.queueHint": "当前任务继续执行；这条消息将在下一轮自动发送",
    "composer.keyboardHint": "Enter 发送 · Shift + Enter 换行",
    "model.settings": "模型设置",
    "model.label": "模型",
    "model.effort": "推理等级",
    "model.appliesNext": "应用于下一轮",
    "model.loading": "正在加载模型…",
    "model.unavailable": "无法读取模型",
    "model.saved": "模型设置已更新",
    "effort.low": "低",
    "effort.medium": "中",
    "effort.high": "高",
    ...
    "toast.steered": "指令已追加",
    "toast.queued": "已排队，当前位置 {position}",
    "toast.queueCancelled": "已取消排队消息",
    "toast.stopSent": "已发送停止请求",
    "toast.submitted": "已提交",
    "toast.refreshed": "已刷新",
    "toast.archived": "会话已归档",
    "toast.takeoverComplete": "电脑端已释放，正在发送排队消息",
    "archive.confirm": "确定归档“{title}”吗？可在其他 Codex 客户端中恢复。",
    "takeover.title": "电脑端正在占用此会话",
    "takeover.description": "已有手机消息排队，正在等待电脑端 Codex writer 释放。",
    "takeover.confirm": "确定接管“{title}”吗？\n\n已确认电脑端任务空闲，且这个 VS Code Codex App Server 只持有该会话。将停止进程 PID {pid}；不会停止 VS Code、OpenClaw 或手机 Bridge。",
    "takeover.owner_missing": "电脑端 writer 已退出，正在重试排队消息。",
    "takeover.protected_owner": "当前 writer 属于手机 Bridge，不能停止。",
    "takeover.unsupported_owner": "持锁者不是已验证的 VS Code Codex 进程，已拒绝接管。",
    "takeover.multiple_owners": "检测到多个持锁者，已拒绝接管。",
    "takeover.shared_owner": "该电脑端 Codex 进程同时持有 {count} 个会话；为保护这些会话的历史记录，已拒绝接管。",
    "takeover.active_remote_turn": "电脑端任务仍在运行；请先在电脑端停止任务。为保护会话历史，手机端不会强制接管。",
    "takeover.thread_state_unknown": "无法确认电脑端任务已经空闲，已拒绝接管。",
    "takeover.unsupported_platform": "安全进程接管目前只支持 Windows。",
    ...
    "errors.invalid_send_mode": "不支持的消息发送模式",
    "errors.invalid_model_settings": "请选择有效的模型和推理等级",
    "errors.thread_has_queued_messages": "当前会话仍有排队消息，请在发送完成后归档",
    "errors.turn_active": "当前会话仍在运行；可选择追加指令或先停止",
    "errors.thread_in_use": "此会话正在另一个 Codex 客户端中打开，请先在桌面端关闭后重试，或在手机端新建会话",
    "errors.queue_dispatching": "该消息正在尝试发送，请稍等后再取消",
    "errors.queued_message_not_found": "该排队消息已发送或已取消",
    ...
    "errors.codex_recovering": "Codex 请求队列正在恢复，请在 {seconds} 秒后重试",
    "errors.archive_busy": "已有会话正在归档，请完成后再试",
    "errors.archive_timeout": "归档未及时确认，主连接仍可使用；请刷新列表确认结果",
    "errors.archive_unavailable": "独立归档服务启动失败，请稍后重试",
    ...
    "errors.invalid_thread_client": "会话来源无效",
    "errors.takeover_not_needed": "此会话已不再被其他客户端阻塞",
    "errors.takeover_busy": "会话接管正在进行",
    "errors.takeover_protected_owner": "当前 writer 属于手机 Bridge，不能停止",
    "errors.takeover_unsupported_owner": "持锁者不是已验证的 VS Code Codex 进程",
    "errors.takeover_multiple_owners": "检测到多个持锁者，已拒绝接管",
    "errors.takeover_shared_owner": "电脑端 Codex 进程还持有其他会话，不能安全停止",
    "errors.takeover_active_remote_turn": "电脑端任务仍在运行；为保护会话历史，已拒绝强制接管",
    "errors.takeover_thread_state_unknown": "无法确认电脑端任务状态，已拒绝接管",
    "errors.takeover_unsupported_platform": "安全进程接管目前只支持 Windows",
    "errors.takeover_owner_changed": "电脑端持锁进程已变化，请重新检测并确认",
    "errors.takeover_failed": "无法安全释放电脑端 writer",
