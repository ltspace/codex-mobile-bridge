...
const messages = {
  en: {
    ...
    "takeover.confirm": "Take over “{title}”?\n\nThis will stop the VS Code Codex App Server process PID {pid}. It may interrupt unfinished Codex work in that VS Code window. It will not stop VS Code, OpenClaw, or the mobile Bridge.",
  ...
  "zh-CN": {
    ...
    "takeover.confirm": "确定接管“{title}”吗？\n\n这会停止 VS Code Codex App Server 进程 PID {pid}，可能中断该 VS Code 窗口中尚未完成的 Codex 工作；不会停止 VS Code、OpenClaw 或手机 Bridge。",
